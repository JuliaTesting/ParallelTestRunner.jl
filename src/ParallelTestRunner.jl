...
# AbstractTestRecord, TestRecord, parent, memory_usage, init_time, getindex
include("records.jl")

include("history.jl")
using .TestHistory

# get_max_worker_rss, DEFAULT_MEMORY_PER_WORKER, default_njobs
include("resources.jl")

# TestIOContext, test_IOContext, print_header, print_test_started, print_test_finished,
# print_test_failed, print_test_crashed, truncate_line
include("printing.jl")

# WorkerTestSet, execute, runtest
include("execute.jl")
